...
Product: A red black tree class that outputs itself in dot syntax to produce
         a graphical representation of itself using Graphviz. Sample output
	 with jpg files are included.

Description: The red black tree is implemented with the same main function
             used in the binary tree assignment. 
             The user enters a number as part of the command line argument to
             run the program. The number will become the amount of nodes that
             gets put into the tree.
             
             Running the program will result in 3 files: a.dot b.dot c.dot
             a.dot - contains the first version of the red black tree
             ...
             The tree will have nodes colored either red or black. A rectangular
             node represents a none node.
             
How to run: > python3.3 redBlackTree.py {}
