...
Product: An AVL tree class that outputs data in dot syntax to produce
         a graphical representation of itself using Graphviz. Sample outputs
	 with in jpg are included.
...
Description: The user enters a number as part of the command line argument to
             ...
             The tree will have nodes that are oval shaped. A rectangular box
             represents a none node.
             
How to run: > python3.3 avlTree.py {}
